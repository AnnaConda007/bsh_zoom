...
export const createMeet = async (
  ...
  try {
    ...
    await axios.get('https://servzoom.onrender.com/newConference', {
      params: {
...
export const updateConferenceInfo = async (
  ...
  try {
    ...
    const id = idTopic
    const data = newData
    const response = await axios.patch('https://servzoom.onrender.com/updateConferenceInfo', {
...
export const deleteConference = async (conferenceId, SetErrorExsist, SetErrorMessage) => {
  try {
    ...
    const response = await axios.delete('https://servzoom.onrender.com/deleteConference', {
      data: {
        accessToken: accessToken,
        id: id,
      },
