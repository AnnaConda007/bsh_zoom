const zoomAutenficationErrorMassage = () => {
  return (
    <>
      <p>
        Похоже, вы не прошли аутентификацию в аккаутнте ZOOM или используете неправильный аккаунт. Пожалуйста, убедитесь, что вы вводите правильные данные и повторите попытку
        входа.
      </p>
      <a
